...
public class RedisVectorConfig {
    ...
    @Bean
    public JedisPooled jedisPooled(@Value("${vector.redis.host:localhost}") String host,
                                   @Value("${vector.redis.port:6380}") int port,
                                   @Value("${vector.redis.password:}") String password) {
